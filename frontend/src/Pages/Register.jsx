...
const Register = () => {
    ...
    const submitHandler = async (e) => {
        ...
        setIsSuccess(true);
        setErrorMessage('Regestration succesfull');
        setTimeout(()=>{
            navigate('/login');
        },4000);
  ...
  return (
    ...
    <form className='w-full max-w-xs' onSubmit={submitHandler}>
        <input type="text" placeholder='Username' name="name" value={userData.name} onChange={chagneInputHandler} 
        className='shadow border rounded-md w-full py-2 px-3 text-gray-700'
        />
        <input type="text" placeholder='Email' name="email" value={userData.email} onChange={chagneInputHandler} 
        className='shadow border rounded-md w-full py-2 px-3 text-gray-700'
        />
        <input type="password" placeholder='Password' name="password" value={userData.password} onChange={chagneInputHandler} 
        className='shadow border rounded-md w-full py-2 px-3 text-gray-700'
        />
        <input type="password" placeholder='Confirm password' name="password2" value={userData.password2} onChange={chagneInputHandler} 
        className='shadow border rounded-md w-full py-2 px-3 text-gray-700'
        />
